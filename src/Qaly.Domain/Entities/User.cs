...
public class User : BaseEntity
{
    ...
    public ICollection<WorkGroup> OwnedWorkGroups { get; set; } = new List<WorkGroup>();
    public ICollection<WorkGroupMember> WorkGroupMemberships { get; set; } = new List<WorkGroupMember>();

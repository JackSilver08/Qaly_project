...
public interface IGroupsService
{
    ...
    Task<Result<GroupDto>> MarkReadAsync(Guid groupId, CancellationToken ct = default);
    Task<Result<GroupDto>> UpdateNotificationPreferenceAsync(Guid groupId, UpdateGroupNotificationPreferenceRequest request, CancellationToken ct = default);
    ...
    Task<Result<GroupPollDto>> UpdatePollAsync(Guid groupId, Guid pollId, UpdateGroupPollRequest request, CancellationToken ct = default);
    ...
    Task<Result<GroupMessageDto>> ForwardMessageAsync(Guid groupId, Guid messageId, ForwardGroupMessageRequest request, CancellationToken ct = default);
